<template>
  <div class="bg-gray-100 py-20">
    <div class="container mx-auto">
      <div class="grid grid-cols-1 xs:mt-10 text-center sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-4 md:gap-0">
        <!-- Feature 1 -->
        ...
        <div
          ...
          <p class="mt-5 text-base text-gray-600">Experience a wide selection of up to 12 rackets during a 2-3 hour
            session at your local court. This extensive trial ensures you find the perfect fit for your game.</p>
        </div>
        ...
        <div
          ...
          <p class="mt-5 text-base text-gray-600">Receive expert advice from our ERSA-certified stringing expert to
            fine-tune your selection and optimize your racket's performance.</p>
        </div>
        ...
        <div
          ...
          <p>&nbsp;</p>
          <p class="mt-5 text-base text-gray-600">Experience the rackets in a real-world setting, allowing you to make
            the most informed decision for your game.</p>
        </div>
      </div>
    </div>
  </div>
